    ...
    return (
        <footer className='bg-gray-900 text-white'>
            <div className='md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#ffffff19] py-7'>
                ...
                md:w-2/5 '><span className='text-teal-400'>Join</span> Our newsletter for latest updates</h1>
                <div>
                    <input type="email" placeholder='Enter gmail here' className='text-gray-800 sm:w-72 w-full
                    ...
                    px-5 py-2.5 rounded-md text-white md:w-auto w-full'>Submit</button>
                </div>
            </div>
            <ItemsContainer />
